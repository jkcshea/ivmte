...
summary(r)
#> 
#> Bounds on the target parameter: [-0.6189617, -0.61894]
#> Audit terminated successfully after 1 round 
#> MTR coefficients: 4 
#> Independent/total moments: 5/5 
#> Minimum criterion: 0.08397346 
#> Solver: Gurobi ('gurobi')
#> 
#> Bootstrapped confidence intervals (backward):
#>     90%: [-0.6369916, -0.6027183]
#>     95%: [-0.6399295, -0.5995175]
#>     99%: [-0.6425555, -0.5972239]
#> p-value: 0
#> Bootstrapped specification test p-value: 0.66
#> Number of bootstraps: 50
...
#> 
#> Bootstrapped confidence intervals (nonparametric):
#>     90%: [-0.5996393, -0.5047288]
#>     95%: [-0.6071737, -0.5022459]
#>     99%: [-0.6104396, -0.5009046]
#> p-value: 0
#> Bootstrapped J-test p-value: 0.48
#> Number of bootstraps: 50
```
