...
The `l` function allows the user to list variables and expressions without quotations.
...
Similar to the `components` option, the `subset` option should be passed using the `l` function.
